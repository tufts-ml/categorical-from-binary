...
def make_data_generation_configs(
    ...
    datasets; (K,M,N,ssq_high, seed), where K is the number of categories, M is the number of covariates,
    N is the number of samples, ssq_high controls the categorical response predictability, and seed is a seed.
