"""
Here we demo the predictive performance of the CBC-Logit over time, 
comparing it to CBC-Probit.   In both cases, we use the IB approximation,
...
holdout_performance_dict = {
    ...
    ("Mean Log Likelihood", "CBC-Logit"): results_logit.holdout_performance_over_time[
        "mean holdout log likelihood for CBC_LOGIT"
    ],
    ("Mean Log Likelihood", "CBC-Probit"): results_probit.holdout_performance_over_time[
        "mean holdout log likelihood for CBC_PROBIT"
    ],
    ("Mean Log Likelihood", "CBM-Logit"): results_logit.holdout_performance_over_time[
        "mean holdout log likelihood for CBM_LOGIT"
    ],
    ("Mean Log Likelihood", "CBM-Probit"): results_probit.holdout_performance_over_time[
